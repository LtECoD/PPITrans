...
def load_proteins(split, _dir):
    seqs = open(os.path.join(_dir, split+".seq")).readlines()
    proteins = []
    for seq in seqs:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pretrained_emb_dir", type=str, default='./experiments/data/secondary_structure/embs')
    parser.add_argument("--self_dir", type=str, default="./experiments/secondary_structure")
    parser.add_argument("--protein_dir", type=str, default="./experiments/data/secondary_structure")
    ...
    train_proteins = load_proteins('train', args.protein_dir)
    test_proteins = load_proteins('test', args.protein_dir)
    ...
    for pro in train_proteins + test_proteins:
        pro.set_emb(np.load(os.path.join(args.pretrained_emb_dir, pro.name+".npy")))
